...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '9f65d542-2fe4-4008-b3a7-d9df662afcaf')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('9f65d542-2fe4-4008-b3a7-d9df662afcaf')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd961e946-f508-494d-9772-f722e770f2b8')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d961e946-f508-494d-9772-f722e770f2b8')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '0e41e7e7-fb41-4fd3-b07f-6a7aad18516d')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('0e41e7e7-fb41-4fd3-b07f-6a7aad18516d')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '6ef5f143-e7c6-4cdf-a666-708be2418f07')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('6ef5f143-e7c6-4cdf-a666-708be2418f07')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '4bc3ef18-a3d7-4c16-bb59-a57d9ed9d47f')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('4bc3ef18-a3d7-4c16-bb59-a57d9ed9d47f')
...
begin
    ...
    select @roomId1 = Id from dbo.RoomTypes where Title='Two Queen SIze Bed';
    select @roomId1 = Id from dbo.RoomTypes where Title='Executive Suite';
